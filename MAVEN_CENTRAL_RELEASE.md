# Maven Central release: goldenera-cryptoj 0.0.1

Coordinates:

```xml
<dependency>
    <groupId>global.goldenera.cryptoj</groupId>
    <artifactId>goldenera-cryptoj</artifactId>
...
https://repo1.maven.org/maven2/global/goldenera/cryptoj/goldenera-cryptoj/0.0.1/
...
This repository keeps the approved coordinates unchanged: `global.goldenera.cryptoj:goldenera-cryptoj:0.0.1`.
